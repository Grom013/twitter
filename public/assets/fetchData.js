export async function fetchData() {
  try {
    const responseTopics = await fetch('https://dpg-co6qgumv3ddc73c79nr0-a.oregon-postgres.render.com/topics.json');
    const responseLastMessages = await fetch('https://dpg-co6qgumv3ddc73c79nr0-a.oregon-postgres.render.com/lastMessages.json');
    const responseBlogs = await fetch('https://dpg-co6qgumv3ddc73c79nr0-a.oregon-postgres.render.com/blogs.json');
